        ...
        <div class="carousel-item ">
          ...
          <div class="container">
            <div class="carousel-caption ">
              ...
              <p>Mets toi dans un environnement stable.</p>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p> Réponds avec honnêteté même si les réponses ne te plaisent pas.</p>
              <p> <a class="btn btn-lg btn-primary" href="">Pour plus de test ! </p>
            </div>
          </div>
        </div>
        <div class="carousel-item">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <p>La maîtrise de soi émotionnelle c'est la capacité à moduler ces émotions et à rester calme face à des situations stressantes,
             négatives ou qui provoquent de fortes réactions émotionnelles. 
          </p>
        ...
        <div class="col-lg-4">
          ...
          <p>L'utilisation émotionnelle, c'est également par la mise en relation cohérente de l'état émotionnel et du choix des activités. 
          </p>
